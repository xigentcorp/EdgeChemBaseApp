report 50057 "EC-Purchase Document - Test"
{
    DefaultLayout = RDLC;
    RDLCLayout = './EC-PurchaseDocumentTest.rdlc';
    Caption = 'EC-Purchase Document - Test';
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem(CopyLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(Purchase_Line___Unit_of_Meas; "Purchase Line"."Unit of Measure Code")
                        {
                        }
                        ...
                        column(Purchase_Line__UOMCaption; "Purchase Line".FieldCaption("Unit of Measure Code"))
                        {
                        }
                        ...
                        begin
                            ...
                            with "Purchase Line" do begin
                                ...
                                if "Line No." > OrigMaxLineNo then begin
                                    ...
                                    TableID[1] := DimMgt.TypeToTableID4(Type);
