report 50050 "ec Purchase Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ec Purchase Order.rdlc';
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Purchase Line"; "Purchase Line")
                    {
                        ...
                        begin
                            ...
                            //msc calc VAT if ("Purchase Header"."Tax Area Code" <> '') and not UseExternalTaxEngine then
                            ...
                            if OnLineNumber = NumberOfLines then begin
                                ...
                                TaxAmount := VATAmountLine.GetTotalVATAmount;



                                /*
                                //MCcc Calc Vat if "Purchase Header"."Tax Area Code" <> '' then begin
