report 50052 "ec Sales Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ec Sales Invoice.rdlc';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(FaxNoCaption; FaxNoLbl)
                    {
                    }
                    column(HomePageCaption; CompanyInformation."E-Mail")
                    {
                    }
                    ...
                    column(OurOrderNoCaption; "Sales Invoice Header"."Location Code")
                    {
                    }
    ...
    var
        ...
        OrderQtyCaptionLbl: Label 'Qty. Ord';
    ...
    begin
        ...
        if LineFeeNoteOnReportHist.FindSet then begin
            ...
            LineFeeNoteOnReportHist.SetRange("Language Code", xLanguage."Windows Language Name");
