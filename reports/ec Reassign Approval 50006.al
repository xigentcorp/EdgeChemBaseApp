report 50006 "ec Reassign Request"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ec Reassign Request.rdlc';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(PageLoop; "Integer")
            {
                ...
                dataitem("Sales Line"; "Sales Line")
                {
                    ...
                    column(ProductGroup; "Sales Line"."Shortcut Dimension 2 Code")
                    {
                    }
                    column(QtyToShip; "Sales Line"."Qty. to Ship")
                    {
                    }
                    trigger OnAfterGetRecord()
                    begin
                        if ("Sales Line"."Quantity Shipped" = "Sales Line".Quantity) and ("Sales Line".Type = "Sales Line".Type::Item) then
                            CurrReport.Skip();
