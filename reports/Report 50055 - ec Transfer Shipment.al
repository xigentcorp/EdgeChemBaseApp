report 50055 "ec Transfer Shipment"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ec Transfer Shipment.rdlc';
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(ExcludeShpLines; ExcludeShpLines)
                    {
                        ApplicationArea = All;
                        Caption = 'Show Shipped Only';
                    }
                }
            }
        }
