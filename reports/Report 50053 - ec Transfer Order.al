report 50053 "ec Transfer Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ec Transfer Order.rdlc';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Transfer Line"; "Transfer Line")
                    {
                        ...
                        column(QtyToShip; "Transfer Line"."Qty. to Ship")
                        {
                        }
                        column(QtyOutstanding; "Transfer Line"."Outstanding Quantity")
                        {
                        }
                        column(ProductGroup; "Transfer Line"."Shortcut Dimension 2 Code")
                        {
                        }
